...
urlpatterns = [
    ...
    path('about-us/', cache_page(60 * 15)(views.AboutView.as_view()), name="about" ),
    path('product/<slug>', cache_page(60 * 15)(views.DetailView.as_view()), name="details" ),
       ...
       path('contact/', cache_page(60 * 15)(views.ContactView.as_view()), name="contact" ),
        ...
        path('signup/', views.SignupView.as_view(), name="signup" ),
            path('forgot-password/', views.ForgotView.as_view(), name="forgot" ),
              path('payment/success/', cache_page(60 * 15)(views.ConfirmView.as_view()), name="pay" ),
                 path('payment/receipt/', cache_page(60 * 15)(views.PaystackView.as_view()), name="payment" ),
                 path('dashboard/', cache_page(60 * 15)(views.DashboardView.as_view()), name="dashboard" ),
       path('dashboard/orders/', cache_page(60 * 15)(views.OrderView.as_view()), name="order" ),

      path('dashboard/address/', cache_page(60 * 15)(views.AddressView.as_view()), name="address" ),
    ...
    path('dashboard/order/<pk>', cache_page(60 * 15)(views.OrderDetailView.as_view()), name='ordered-detail'),
    path('wishlist/product/<slug>/', views.wishlist_product, name='wishlist-product'),
    path('category/<slug>/', cache_page(60 * 15)(views.CategoryView), name='categoryview'),
